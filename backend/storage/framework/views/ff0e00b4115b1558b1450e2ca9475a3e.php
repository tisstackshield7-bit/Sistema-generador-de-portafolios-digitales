...
<body style="margin:0;padding:0;background:#eef3fb;font-family:Arial,Helvetica,sans-serif;color:#1f2a44;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
        PortafolioPro - Usa esta contrasena temporal de acceso. Estara disponible durante <?php echo e($expireMinutes); ?> minutos.
    </div>
                    ...
                    <tr>
                        <td style="padding:32px 36px 36px;">
                            ...
                            <div style="font-size:15px;line-height:1.7;color:#42526f;margin-bottom:10px;">
                                Esta contrasena temporal estara disponible durante <?php echo e($expireMinutes); ?> minutos.
                            </div>
                            <div style="font-size:15px;line-height:1.7;color:#42526f;margin-bottom:10px;">
...
<?php /**PATH D:\Sistema-generador-de-portafolios-digitales\backend\resources\views/emails/temporary-password.blade.php ENDPATH**/ ?>