...
<head>
    ...
    <title>contraseña temporal - PortafolioPro</title>
</head>
<body style="margin:0;padding:0;background:#eef3fb;font-family:Arial,Helvetica,sans-serif;color:#1f2a44;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
        PortafolioPro - Usa esta contraseña temporal de acceso. Estara disponible durante {{ $expireMinutes }} minutos.
    </div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:620px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 30px rgba(31,42,68,.08);">
                    ...
                    <tr>
                        <td style="padding:32px 36px 36px;">
                            <div style="font-size:28px;line-height:1.25;font-weight:700;color:#0d1f4f;margin-bottom:16px;">contraseña temporal de acceso</div>
                            ...
                            <div style="font-size:16px;line-height:1.7;color:#42526f;margin-bottom:20px;">
                                Usa esta contraseña temporal de 8 caracteres para iniciar sesion:
                            </div>
                            ...
                            <div style="font-size:15px;line-height:1.7;color:#42526f;margin-bottom:10px;">
                                Esta contraseña temporal estara disponible durante {{ $expireMinutes }} minutos.
                            </div>
                            <div style="font-size:15px;line-height:1.7;color:#42526f;margin-bottom:10px;">
                                Despues de iniciar sesion, te enviaremos automaticamente a la pantalla para cambiar tu contraseña.
                            </div>
